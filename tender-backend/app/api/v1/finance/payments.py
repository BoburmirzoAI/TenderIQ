...
from app.schemas.finance.payment import ClickWebhookData, PaymeWebhookData, PaymentCreate, PaymentRead
...
def _verify_payme_auth(request: Request) -> None:
    ...
    if not settings.PAYME_SECRET_KEY:
        raise HTTPException(status_code=503, detail="Payme not configured")
    ...
    try:
        ...
        # ValueError covers binascii.Error (bad base64) and missing ":" in header
