...
class NotificationService:
    ...
    async def send_match_email(self, user_email: str, user_name: str, tender: dict) -> bool:
        ...
        safe_title = tender.get("title", "")[:60].replace("\n", " ").replace("\r", " ")
        return await self.send_email(user_email, f"Yangi mos tender: {safe_title}", html)
    ...
    async def send_password_reset_email(self, user_email: str, full_name: str, reset_url: str) -> bool:
        ...
        return await self.send_email(user_email, "TenderIQ — Parolni tiklash", html)

    async def send_email_verification(self, user_email: str, full_name: str, verify_url: str) -> bool:
        ...
        return await self.send_email(user_email, "TenderIQ — Email manzilingizni tasdiqlang", html)
