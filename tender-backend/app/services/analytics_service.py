...
from app.schemas.analytics import CompetitorAnalysis, CompetitorRead, MarketOverview, PriceHistory
...
class AnalyticsService:
    ...
    async def get_competitors(
        ...
        concentration = (top_amount / total_amount * 100) if total_amount > 0 else 0
    ...
    async def get_market_overview(self) -> MarketOverview:
        ...
        return MarketOverview(
            total_active_tenders=status_counts.get("active", 0),
            total_closed_tenders=status_counts.get("closed", 0),
            avg_amount_by_category={},
            tender_count_by_region={},
